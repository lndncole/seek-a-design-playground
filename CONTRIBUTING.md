...
1. Make commits to your feature branch. Prefix each commit as described in *Detailed Workflow* below
1. When you've finished your fix or feature, Rebase upstream changes into your branch. Submit a pull request directly to master. Include a description of your changes.
...
Use github’s interface to make a fork of the repo, then clone your new fork down to your local machine, and add the original repo as an upstream remote:
...
1. Uphold the current code standard:
    ...
    - Apply the [boy scout rule](https://www.matheus.ro/2017/12/11/clean-code-boy-scout-rule/).
